  ...
  var prompt = "> ",
    ...
    commands = {
      "kittens": function() {
        ...
        setTimeout(function() {
          animatedLog("> Did that work? ", "#00FF00", "animatedIntroMessage3", function() {
            animatedLog("> Oh well, maybe the page is lost forever.", "#00FF00", "animatedIntroMessage4", function() {
              animatedLog("> If you believe this is a problem, try contacting the server administer.", "#00FF00", "animatedIntroMessage5", function() {
                animatedLog("> He like kittens too!", "#00FF00", "animatedIntroMessage6", function() {
                  newline();
                }, 400, 1000);
              }, 1400, 1000);
            }, 800, 1000);
