...
CREATE TABLE `dicionario` (
  ...
  FULLTEXT KEY `expressao` (`expressao`),
  FULLTEXT KEY `significado` (`significado`),
  FULLTEXT KEY `significado_2` (`significado`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;

insert into dicionario(id_dicionario, expressao, significado) values('0', 'vc', 'voce');
...
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('1', 'teste', '2017-12-13 12:41:45', 'testeoo', '', '0');
...
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('27', 'Quais são as armas dos Storm Trooper', '2018-03-22 09:56:49', '', '::1', '0');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('28', 'Uui tft', '2018-03-22 10:19:58', '', '::1', '0');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('29', 'Utyyu', '2018-03-22 10:20:09', '', '::1', '0');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('30', '46941649sgjgdshldgshl', '2018-03-22 10:20:31', '', '::1', '0');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('31', 'Cu', '2018-03-22 10:20:46', '', '::1', '0');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('32', 'Cu', '2018-03-22 10:20:53', '', '::1', '0');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('33', 'Cu', '2018-03-22 10:21:06', '', '::1', '0');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('34', 'ONDE fica tATUINI', '2018-03-22 10:35:52', '', '::1', '0');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('35', 'Vai tu te fuder', '2018-03-22 10:37:32', '', '::1', '0');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('36', 'Hitler', '2018-03-22 10:38:02', '', '::1', '0');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('37', 'Quais são as armas dos Storm Trooper4', '2018-04-02 10:12:06', '', '::1', '0');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('38', 'Oque é star wars', '2018-04-02 10:16:35', '', '::1', '0');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('39', 'Então star trek', '2018-04-02 10:16:47', '', '::1', '0');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('40', 'Hbhi', '2018-04-07 08:54:33', '', '::1', '0');
...
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('42', 'Boa tardi', '2018-04-07 11:40:23', '', '::1', '0');
...
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('44', 'Bon di/a', '2018-04-07 11:42:17', '', '::1', '0');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('45', 'Bom dia/', '2018-04-07 11:42:25', '', '::1', '0');
...
CREATE TABLE `pergunta` (
  ...
  FULLTEXT KEY `pergunta_2` (`pergunta`),
  FULLTEXT KEY `pergunta_3` (`pergunta`)
...
insert into report(id_report, email, nome, texto, visto, data_envio, data_visto, visuaizado_por, ip) values('6', 'email@meueamil', 'Genoveva', 'pq ele não ta responde direito minhas perguntas?', '0', '2017-12-15 11:05:38', '0000-00-00 00:00:00', '0', '::1');
