...
insert into respota(id, resposta) values('39', 'Ele tem 2 filhos
');
insert into respota(id, resposta) values('40', 'Este é o nome do meu criador');
insert into respota(id, resposta) values('41', '--');
