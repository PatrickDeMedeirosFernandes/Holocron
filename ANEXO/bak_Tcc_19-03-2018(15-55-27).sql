...
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('20', 'Aa', '2018-03-19 13:41:05', '', '::1', '');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('21', 'Que e o yoda', '2018-03-19 13:43:46', '', '::1', '');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('26', 'Ad', '2018-03-19 14:21:11', '', '::1', '');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('27', 'Ad', '2018-03-19 14:21:42', '', '::1', '');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('28', 'Uu', '2018-03-19 14:21:54', '', '::1', '');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('29', 'Uu', '2018-03-19 14:21:56', '', '::1', '');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('30', 'Uu', '2018-03-19 14:21:58', '', '::1', '');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('31', '', '2018-03-19 14:22:13', '', '::1', '');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('32', '', '2018-03-19 14:22:16', '', '::1', '');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('33', 'Uu', '2018-03-19 14:22:18', '', '::1', '');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('34', 'Da', '2018-03-19 14:37:48', '', '::1', '');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('35', 'Quem é o ioda', '2018-03-19 14:38:21', '', '::1', '');
insert into perg_sem_resp(id_perg_sem_resp, pergunta, data, resposta, ip, resposta_pergunta) values('36', 'Quem é o ioda', '2018-03-19 14:38:31', '', '::1', '');
...
CREATE TABLE `perg_user` (
  ...
  UNIQUE KEY `id_perg_user` (`id_perg_user`),
  UNIQUE KEY `data` (`data`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=latin1;

insert into perg_user(id_perg_user, pergunta, valida, data, respota_perg_user) values('26', 'Quem é a esposa de anaquim', '1', '2018-03-19 14:40:59', '1');
...
', '1', '2017-12-15 09:22:10', '2018-03-19 13:59:45', '0', '::1');
insert into report(id_report, email, nome, texto, visto, data_envio, data_visto, visuaizado_por, ip) values('6', 'email@meueamil', 'Genoveva', 'pq ele não ta responde direito minhas perguntas?', '1', '2017-12-15 11:05:38', '2018-03-19 13:59:33', '0', '::1');
