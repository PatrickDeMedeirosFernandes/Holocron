...
Dado <input type="text" class="form-control" id="fone" value="lingua" name="DADO[]" /> 
...
Valor <input type="text" style="background-color: #000; color:#fff"  value="" class="form-control" id="fone" name="VALOR[]" />
Dado <input type="text" class="form-control" id="fone" value="" name="DADO[]" /> 
